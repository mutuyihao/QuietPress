  ...
  useEffect(() => {
    ...
    const enhanceBlocks = () => {
      ...
      preBlocks.forEach((pre) => {
        ...
        copyBtn.className =
          "code-copy-btn text-[10px] font-sans tracking-wide text-muted-foreground/75 hover:text-foreground border border-border/40 bg-background/80 hover:bg-background px-2 py-0.5 rounded transition-all duration-200 cursor-pointer focus:outline-none";
