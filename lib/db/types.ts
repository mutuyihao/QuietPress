...
export interface PostRepository {
  list(page?: number, pageSize?: number): Promise<PaginatedResult<PostWithTags>>
  ...
  saveRevision(postId: string, data: { title: string; contentMarkdown: string; excerpt: string | null; userId: string }): Promise<void>
}
